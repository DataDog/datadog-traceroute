...
require (
	github.com/DataDog/datadog-agent/pkg/network/driver v0.0.0-20250826191950-02fbad99ddbc
...
require (
	...
	github.com/DataDog/datadog-agent/pkg/telemetry v0.0.0-20250825145935-495d9886bae6 // indirect
	...
	github.com/DataDog/datadog-agent/pkg/util/winutil v0.0.0-20250825145935-495d9886bae6 // indirect
