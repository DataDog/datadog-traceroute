...
//
// This function delegates to the localaddr package which handles automatic fallback
// for cases like WireGuard interfaces with large interface indices.
func LocalAddrForHost(destIP net.IP, destPort uint16) (*net.UDPAddr, net.Conn, error) {
	return localaddr.ForHost(destIP, destPort)
}
